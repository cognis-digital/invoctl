#!/usr/bin/env sh
# Universal installer for invoctl. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/invoctl.git"
echo "Installing invoctl ..."
