"""INVOCTL core — CLI invoicing + payment-link generator with PDF and a local ledger."""
...
RULES = [
    ("INV-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("INV-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("INV-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
